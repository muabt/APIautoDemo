...
public class CommonDefs {
	 ...
	 *
	 * @param path
	 *            path to the specific action. Eg: Compliance
	 */
	 ...
	 *
	 * @param path
	 *            path to the data space. Eg: FastTrack>[03] Parties
	 ...
	 *
	 * @param tblName
	 *            table name that user want to access
	 */
	@And("^I access table \"([^\"]*)\"$")
	...
	public void iAccessDataspaceThenAccessDatasetThenAccessTable(String dataspacePath, String datasetPath,
			String tableName) {
