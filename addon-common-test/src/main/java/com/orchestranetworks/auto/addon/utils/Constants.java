...
public final class Constants {
    ...
    public static final String BTN_CREATE_CHILD_DATASET = "Create a child dataset";
    ...
    public static final String BTN_PERSPECTIVE = "Select perspective";
    public static final String BTN_ACTIONS = "Actions";
    ...
    public static final String LAST_PK = "LAST_PK";
}
