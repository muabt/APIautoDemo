...
public class DMDVConfigurationPage extends WebPageObject {
	...
	public void clickMenuVisualization() {
		...
		waitElementToBePresent("//td//*[text()='" + DMDVConfigurationPage.DMDV_ADDON_FULL_PRODUCT_NAME + "']")
	...
	public void click_outside() {
		clickOnElement("//div[@class='ebx_WorkspaceFormTabview_Header']");

	}

	public void click_node_style() {
		clickOnElement("//a[em/span[text()='Node Style']]");
	}

	public void input_to_background_color(String value) {
		if (!value.isEmpty()) {
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'background')]",
					"#" + value);
		} else
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'background')]",
					value);
	...
	public void input_to_border_color(String value) {
		if (!value.isEmpty()) {
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'border')]",
					"#" + value);
		} else
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'border')]", value);

	}

	public void input_to_border_width(String value) {
		waitTypeAndTab("//input[contains(@name, 'borderWidth')]", value);

	}

	public void input_to_border_style(String value) {
		clickOnElement("//select[contains(@name, 'borderStyle')]");
		clickOnElement("//select[contains(@name, 'borderStyle')]/option[. = '" + value + "']");

	}

	public void input_to_label_color(String value) {
		if (!value.isEmpty()) {
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'text')]",
					"#" + value);
		} else
			waitTypeAndTab("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'text')]", value);
	...
	public String get_text_border_style(String value) {
		clickOnElement("//select[contains(@name, 'borderStyle')]");
		WebElement element = driver
				.findElement(By.xpath("//select[contains(@name, 'borderStyle')]/option[. = '" + value + "']"));
		return element.getText();
	}
	...
	public String get_border_color_styles_default() {
		WebElement element1 = driver.findElement(
				By.xpath("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'border')]"));
	...
	public String get_background_color_styles_default() {
		WebElement element = driver.findElement(
				By.xpath("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'background')]"));
		return element.getAttribute("value");
	...
	public String get_label_color_styles_default() {
		WebElement element2 = driver.findElement(
				By.xpath("//div[@class='ebx_ColorPickerPreview_container']/input[contains(@name, 'text')]"));
		return element2.getAttribute("value");
	}

	public void input_color_style_by_color_picker() {
		clickOnElement("//button[@title = 'Color picker']/span[@class ='ebx_Icon']");
		// switchToIFrame("ebx-legacy-component");
		clickOnElement("//div[@class='yui-picker-swatch']");

	}

	public void select_add_icon_background() {
		clickOnElement("//button[@title = 'Add an occurrence']/span");

	}

	public void select_delete_icon_background() {
		clickOnElement("//button[contains(@id, 'backgroundColor_5b') and @title = 'Delete this occurrence.']/span");

	}

	public void input_to_label_in_legend_background(String labelinlegend) {
		waitTypeAndTab("//tr/td/div/input[contains(@name, 'backgroundColor_5b_')]", labelinlegend);

	}

	// public void input_to_label_in_legendx(String labelinlegend) {
	// //By xPath = By.xpath("//tr/td/div/input[contains(@name,
	// 'backgroundColor_5b_')]/preceding-sibling::*)+1");
	// //int position = driver.findElements(xPath).size() + 1;
	// boolean isPresent =
	// driver.findElements(By.xpath("//tr/td/div/input[contains(@name,
	// 'backgroundColor_5b_')]")).size() > 0;
	// if(isPresent==false){
	//
	//// clickOnElement(
	...
	// waitTypeAndTab(
	//
	// "//tr/td/div/input[contains(@name, 'backgroundColor_5b_')];",
	// labelinlegend);
	// }
	// else {
	//
	...
	public void input_to_color_background(String color) {
		if (!color.isEmpty()) {
			waitTypeAndTab(
					"//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'backgroundColor')]",
					"#" + color);
		} else
			waitTypeAndTab(
					"//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'backgroundColor')]",
	...
	public void input_to_condition_background(String condition) {
		waitTypeAndTab("//input[contains(@name,'condition')]", condition);

	}

	public String get_value_labelinlegend_background() {
		WebElement element = driver
				.findElement(By.xpath("//tr[@class = 'ebx_Field ebx_ComplexField ebx_HidingContainer']/td/div/input"));
		return element.getAttribute("value");
	}

	public String get_value_color_background() {
		WebElement element = driver.findElement(By
				.xpath("//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'backgroundColor')]"));
		return element.getAttribute("value");
	}
	...
	public void select_add_icon_label() {
		clickOnElement("//div[contains(@id, 'labelColoreditor')]/button/span");

	}

	public void select_delete_icon_label() {
		clickOnElement("//button[contains(@id, 'labelColor_5b') and @title = 'Delete this occurrence.']/span");

	}

	public void input_to_label_in_legend_label(String labelinlegend) {
		waitTypeAndTab("//tr/td/div/input[contains(@name, 'labelColor_5b_')]", labelinlegend);

	}

	public void input_to_color_label(String color) {
		if (color.isEmpty()) {
			waitTypeAndTab("//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'labelColor')]",
					color);
		} else
	...
	public void input_to_condition_label(String condition) {
		waitTypeAndTab("//tr/td[3]/div/div/input[contains(@name, 'labelColor_5b_')]", condition);
	...
	public String get_value_color_label() {
		WebElement element = driver.findElement(
				By.xpath("//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'labelColor')]"));
		return element.getAttribute("value");
	}

	public String get_value_condition_label() {
		WebElement element = driver
				.findElement(By.xpath("//tr/td[3]/div/div/input[contains(@name, 'labelColor_5b_')]"));
		return element.getAttribute("value");
	}

	public void select_add_icon_border() {
		clickOnElement("//div[contains(@id, 'borderColoreditor')]/button/span");

	}

	public void select_delete_icon_border() {
		clickOnElement("//button[contains(@id, 'borderColor_5b') and @title = 'Delete this occurrence.']/span");

	}

	public void input_to_label_in_legend_border(String labelinlegend) {
		waitTypeAndTab("//tr/td/div/input[contains(@name, 'borderColor_5b_')]", labelinlegend);

	}

	public void input_to_color_border(String color) {
		if (color.isEmpty()) {
			waitTypeAndTab("//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'borderColor')]",
					color);
		} else
	...
	public void input_to_condition_border(String condition) {
		waitTypeAndTab("//tr/td[3]/div/div/input[contains(@name, 'borderColor_5b_')]", condition);
	...
	public String get_value_color_border() {
		WebElement element = driver.findElement(
				By.xpath("//div[@class = 'ebx_ColorPickerPreview_container']/input[contains(@name,'borderColor')]"));
		return element.getAttribute("value");
	}

	public String get_value_condition_border() {
		WebElement element = driver
				.findElement(By.xpath("//tr/td[3]/div/div/input[contains(@name, 'borderColor_5b_')]"));
		return element.getAttribute("value");
	}

	public void select_add_icon_border_style() {
		clickOnElement("//div[contains(@id, 'borderStyleeditor')]/button/span");

	}

	public void select_delete_icon_border_style() {
		clickOnElement("//button[contains(@id, 'borderStyle_5b') and @title = 'Delete this occurrence.']/span");

	}

	public void input_to_label_in_legend_border_style(String labelinlegend) {
		waitTypeAndTab("//tr/td/div/input[contains(@name, 'borderStyle_5b_')]", labelinlegend);

	}

	public void input_value_to_border_style(String style) {

		clickOnElement("//td/div/div/button[@title = 'Open drop-down list' ]");
		String styleXpath = "";
		if (style.contains(" ")) {
		...
		clickOnElement("//div/div/div/div/div[" + styleXpath + "]");

	}

	public void input_to_condition_border_style(String condition) {
		waitTypeAndTab(
				"//tr/td[3]/div/div[contains(@class, 'ebx_FieldDecorator')]/input[contains(@name, 'borderStyle_5b_')]",
				condition);
	...
	public String get_value_style_border_style() {
		WebElement element = driver
				.findElement(By.xpath("//td/div/div/input[contains(@class,'ebx_InputWithEmptyButton')]"));
		return element.getAttribute("value");
	}
	...
	public void select_add_icon_border_width() {
		clickOnElement("//div[contains(@id, 'borderWidtheditor')]/button/span");

	}

	public void select_delete_icon_border_width() {
		clickOnElement("//button[contains(@id, 'borderWidth_5b') and @title = 'Delete this occurrence.']/span");

	}

	public void input_to_label_in_legend_border_width(String labelinlegend) {
		waitTypeAndTab("//tr/td/div/input[contains(@name, 'borderWidth_5b_')]", labelinlegend);

	}

	public void input_value_to_border_width(String width) {

		waitTypeAndTab("//td/div/input[contains(@name,'borderWidth_5b_0_5d___value')]", width);

	}

	public void input_to_condition_border_width(String condition) {
		waitTypeAndTab("//tr/td[3]/div/div/input[contains(@name, 'borderWidth_5b_')]", condition);
	...
	public String get_value_color_border_width() {
		WebElement element = driver
				.findElement(By.xpath("//td/div/input[contains(@name,'borderWidth_5b_0_5d___value')]"));
		return element.getAttribute("value");
	}

	public String get_value_condition_border_width() {
		WebElement element = driver
				.findElement(By.xpath("//tr/td[3]/div/div/input[contains(@name, 'borderWidth_5b_')]"));
		return element.getAttribute("value");
	}
