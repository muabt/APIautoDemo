#Author: tbui@tibco.com and thule@tibco.com
@DMDV120
Feature: Test graph data with configuration
  ...
  Scenario: US06-05 - Check Generated successfully with model Include Field, Groups, Table + PK + No FKs
    Given I access data model "DMP-01"
    And user views data model graph via DMA
   ...
   Scenario: US06-06 - Check Generated successfully with model Include Field, Groups, Table + PKs
    Given I access data model "DMP-02"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA_DMP-02 |               |
  ...
  Scenario: US06-07 - Check Generated successfully with model Include Field, Groups, Table + PKs,FKs
    Given I access data model "DMP-03"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
 ...
 Scenario: US06-08 - Check Generated successfully with model Include Fields, Groups, Tables + Has FK + Same data model + same Table
    Given I access data model "DMP-04"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-09 - Check Generated successfully with model Include Fields, Groups, Tables + Has FK + Same data model + Other Table
    Given I access data model "DMP-05"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
 ...
 Scenario: US06-10 - Check Generated successfully with model Include Fields, Groups, Tables + Has FK + other data model (External data model)
    Given I access data model "DMP-06"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-11 - Check Generated successfully with model Include Fields, Groups, Tables + Has FK + other DataSpace (External data model)
    Given I access data model "DMP-07"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA               |        |
  ...
  Scenario: US06-11.1 - Check Generated successfully with model Include external table (Same TableName, Same Data Model SameSpace, #DataSet)
    Given I access data model "Data_174"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-11.2 - Check Generated successfully with model Include external table (#TabelName&Same Data Model, SameSpace, #DataSet)
    Given I access data model "Data_175"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA |  |
  ...
  Scenario: US06-11.3 - Check Generated successfully with model Include external table (SameTabelName &#DataModel&sameSpace, #DataSet)
    Given I access data model "Data_176"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA |  |
  ...
  Scenario: US06-11.4 - Check Generated successfully with model Include external table (#TabelName&#DataModel&sameSpace, #DataSet)
    Given I access data model "Data_177"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA |  |
  ...
  Scenario: US06-11.5 and US06-11.6 and US06-11.9 - Check Generated successfully with model Include external table (#TabelName&#DataModel&#Space, #DataSet)
    Given I access data model "V120_US07_externalTable"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA_101               |        |
  ...
  Scenario: US06-11.7 - Check Generated successfully with model Include external table (#TabelName&#DataModel&#Space, that have (n)#DataSet)
    Given I access data model "Data_180"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA |  |
  ...
  Scenario: US06-11.8 - Check Generated successfully with model Include external table (#TabelName&(n)#DataModel&sameSpace, (n)#DataSet)
    Given I access data model "Data_181"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA |  |
  ...
  Scenario: US06-11.9 - Check Generated successfully with model Include external table (#TabelName&(n)#DataModel&Space, (n)#DataSet)
    Given user accesses data model "V120_US07-123"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA_123 |  |
    ...
    Then the graph model should contains following fields
      ...
      | namea:String         | TableA_123 |
    Then the graph model should contains following links
      | TableB | TableD     | pkfk_d123.1 |  | 1 |
      | TableB | TableA_123 | pkfk_a123   |  | 1 |
      
  Scenario: US06-12 - Check Generated successfully with model Include Fields, Groups, Tables + Has FKs incomming
    Given I access data model "DMP-08"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-13 - Check Generated successfully with model Include Fields, Groups, Tables + Has FKs outgoing
    Given I access data model "DMP-09"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-14 - Check Generated successfully with model Include Fields, Groups, Tables + Has FKs incomming + Has FKs outgoing
    Given I access data model "DMP-10"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-15 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as FK + Same data model
    Given I access data model "DMP-11"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
 ...
 Scenario: US06-16 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as FK + other data model
    Given I access data model "DMP-12"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-17 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as FK + other DataSpace
    Given I access data model "DMP-13"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-18 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as Over a link table + Same data model
    Given I access data model "DMP-14"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
 ...
 Scenario: US06-19 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as Over a link table + other data model
    Given I access data model "DMP-15"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-20 - Check Generated successfully with model Include Fields, Groups, Tables + Has Association as Over a link table + other DataSpace
    Given I access data model "DMP-16"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
 ...
 Scenario: US06-21 - Check Generated successfully with model Include Fields, Groups, Tables + Reused Simple data types by manual created
    Given I access data model "DMP-20"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-22 - Check Generated successfully with model include Fields, Groups, Tables + Reused Complex data types by manual created
    Given I access data model "DMP-22"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
...
Scenario: US06-23 - Check Generated successfully with model Include Fields, Groups, Tables + many layer between them + Has Inherited field
    Given I access data model "DMP-24"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | Table1                                                                                                                                                                                                                            |        |
    ...
    Then the graph model should contains following fields
      ...
      | id:Integer                                                                                                                                                                                                                               | Table2                                                                                                                                                                                                                            |
      | name:String                                                                                                                                                                                                                              | Table2                                                                                                                                                                                                                            |
      | association4:Table4                                                                                                                                                                                                                      | Table2                                                                                                                                                                                                                            |
      | association5:Table5                                                                                                                                                                                                                      | Table2                                                                                                                                                                                                                            |
      | association6:Table6                                                                                                                                                                                                                      | Table2                                                                                                                                                                                                                            |
      | new:String                                                                                                                                                                                                                               | Table2                                                                                                                                                                                                                            |
      | id:Integer                                                                                                                                                                                                                               | Table3                                                                                                                                                                                                                            |
      | name:String                                                                                                                                                                                                                              | Table3                                                                                                                                                                                                                            |
      | api809                                                                                                                                                                                                                                   | Table3                                                                                                                                                                                                                            |
    ...
    Then the graph model should contains following links
      ...
      | Table2                                                                                                                                                                                                                            | Table21    | fk21          |  | 0..1 |
      | Table2                                                                                                                                                                                                                            | Table4     | fk24          |  | 0..1 |
      | Table2                                                                                                                                                                                                                            | Table5     | fk25          |  | 0..1 |
      | Table2                                                                                                                                                                                                                            | Table1     | fk2-1         |  | 0..1 |
      | Table2                                                                                                                                                                                                                            | Table2     | fk2-2         |  | 0..n |
      | Table2                                                                                                                                                                                                                            | Table3     | fk2-3         |  | 0..n |
      | Table2                                                                                                                                                                                                                            | Table3     | fk2-3-2       |  | 0..1 |
      | Table3                                                                                                                                                                                                                            | Table21    | fk321         |  | 0..1 |
      | Table3                                                                                                                                                                                                                            | Table4     | fk34          |  | 0..1 |
      | Table3                                                                                                                                                                                                                            | Table1     | fk31          |  | 0..1 |
      | Table3                                                                                                                                                                                                                            | Table2     | fk3-2         |  | 0..n |
      | Table3                                                                                                                                                                                                                            | Table5     | fk35          |  | 0..1 |
      | Group1                                                                                                                                                                                                                            | Table2     | fk1           |  | 0..n |
...
Scenario: US06-25 - Check Generated successfully with model Include Fields, Groups, Table + Number of value (Min, Max)
    Given I access data model "DMP-30"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-26 - Check Generated successfully with model Include Fields, Groups, Table + Label and description too long
    Given I access data model "DMP-31"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA                                                                                                                                                                                                                                                                                  |        |
...
Scenario: US06-27 - Check Generated successfully with model Include Fields, Groups, Table + Label and description + MutilLanguage
    Given I access data model "DMP-32"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
  ...
  Scenario: US06-28 - Check Generated successfully with model Include Fields, Groups, Table + Default view and tools (Hidden)
    Given I access data model "DMP-34"
    And user views data model graph via DMA
    Then the graph should be displayed
    Then the graph model should contains following tables and groups
      | TableA      |        |
