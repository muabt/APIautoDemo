...
Feature: Manual Merge
  ...
  Scenario: Check merging process after validate merge view screen
    ...
    And I create child Dataspace with information as following
      ...
      | Resource-child28 | admin admin (admin) |               |
    Then I should see Dataspace with information as following
      ...
      | Resource-child28 | Dataspace |          | Open   | admin admin (admin) | On-demand loading and unloading | Allows validation errors in result | By label                    |
    When I access "dataset" menu
    And I access dataspace "Master Data - Reference > Resource > Resource-child28"
